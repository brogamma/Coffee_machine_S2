...
void report_writing(void)//Starts the logging for the maintainance
{
    ...
    Outfile << "The total amount of inserted money is:" << dec.getMoney_Recieved() << endl;
    Outfile << "The total amount of profit is:" << dec.getMoney_Recieved() - dec.getChange_Dispensed()<< endl;
    Outfile << "The amount of change still available is:" << dec.getChangeLeft() << endl;
    Outfile << "The amount of Cuppuccino still availble is:"<<  dec.getCappuccino_amount() << endl;
    Outfile << "The amount of Macchiato still availble is:"<< dec.getMacchiato_ammount() << endl;
    Outfile << "The amount of Normal coffee still availble is:"<< dec.getCoffee_Ammount() << endl;
    Outfile << "The amount of Change on order is:"<< /* Get_amount_money_orderd()<< */endl;
    Outfile << "The amount of Coffee that is on order is:" << /* Get_amount_Coffee_orderd()<< */endl;
    Outfile << "The amount of Machiato that is on order is:" << /* Get_amount_Machiato_orderd()<< */endl;
    Outfile << "The amount of Cappucino that is on order is:" << /* Get_amount_Cappuicino_orderd()<< */endl;
    Outfile.close();
...
event_t coffee_selection()//event that select the bevrage that is wanted
{
    ...
    while(1){
        cout << "\n\n##Select your bevrage##"<< endl;
        cout << "1-- MACCHIATO       price: 90 cent " << endl;
        cout << "2-- NORMAL COFFEE   price: 60  cent " << endl;
        cout << "3-- CAPPUCCINO      price: 110  cent " << endl;
        cout << "4-- Service" << endl;
...
event_t event_handler(event_t event)
{
    ...
    dec.setPricebevrage(0,110);
    dec.setPricebevrage(2,90);
    dec.setPricebevrage(1,60);
    dec.setMacchiato_ammount(100);
    dec.setCappuccino_amount(100);
    dec.setCoffee_Ammount(100);
    ...
    while (1){
        ...
        case S_DISPENSE_COFFEE:
            dispense_coffee(dec.getInsertedMoney(),dec.getPricebevrage(dec.getKind_Bevrage()));
            system("@cls||clear");
            fflush(stdin);
            dec.next_state= S_INITIALISED;
            break;
        ...
        case S_DISPENSE_COFFEE:
            ...
            //Check_quantity(dec.getKind_Bevrage());
            break;
